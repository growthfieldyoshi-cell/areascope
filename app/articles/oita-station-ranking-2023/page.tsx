...
export default async function OitaStationRanking2023Page() {
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '大分県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          大分県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、大分県で最も利用者が多い駅は別府駅・中津駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          大分県は大分市・別府市・中津市に鉄道利用が分散している特徴があります。国土交通省「国土数値情報」の{year}年データをもとに、大分県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/oita" style={linkStyle}>大分県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>大分県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の大分県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>別府駅が上位の理由</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/beppu-oita-beppushi" style={linkStyle}>別府駅</Link>は日本有数の温泉都市・別府市の玄関口であり、観光需要が大きい駅です。JR日豊本線の主要駅として、観光客に加えて地元住民の通勤・通学利用も支えています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>中津駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/nakatsu-oita-nakatsushi" style={linkStyle}>中津駅</Link>は県北部の拠点駅で、福岡県との県境に位置しています。福岡通勤圏としての性格も持ち、北九州方面への通勤需要が乗降者数に寄与しています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>大分県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              大分県は大分市・別府市・中津市に鉄道利用が分散しているのが特徴です。JR日豊本線が県内の主要な鉄道軸であり、沿線に主要駅が点在しています。観光需要と通勤需要が混在する点も特徴的です。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>別府駅周辺</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              別府駅周辺は温泉観光の中心地として旅館・ホテルが集積しています。観光客向けの商業施設に加えて、住民向けの生活インフラも整っているエリアです。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>中津・宇佐エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              中津市は県北部の商業・行政の中心地で、からあげの聖地としても知られています。福岡県に近く、北九州方面への通勤利便性が高いエリアです。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。大分県では温泉地としての特性も居住環境に影響します。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/oita" style={linkStyle}>大分県の駅ランキング（全件）</Link>では完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の大分県駅乗降者数ランキングでは、別府駅・中津駅が上位を占めています。観光需要と通勤需要が混在する点が大分県の特徴であり、大分市・別府市・中津市に利用が分散しています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>大分県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/oita" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              大分県の全駅ランキング
            </Link>
