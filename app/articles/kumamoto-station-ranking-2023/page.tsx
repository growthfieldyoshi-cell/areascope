...
export default async function KumamotoStationRanking2023Page() {
  ...
  const rows = (await sql`
    ...
    WHERE s.station_group_slug IS NOT NULL
      AND s.prefecture_slug = 'kumamoto'
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '熊本県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          熊本県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、熊本県で最も利用者が多い駅は熊本駅・新水前寺駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          熊本県は九州新幹線の停車駅を持ち、路面電車も市民の足として活躍しています。国土交通省「国土数値情報」の{year}年データをもとに、熊本県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/kumamoto" style={linkStyle}>熊本県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>熊本県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の熊本県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>熊本駅が上位の理由</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/kumamoto-kumamoto-kumamotoshi" style={linkStyle}>熊本駅</Link>は九州新幹線の停車駅であり、JR鹿児島本線と豊肥本線の結節点です。県最大のターミナル駅として、ビジネス・通勤・観光の幅広い需要を集めています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>新水前寺駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/shinsuizenji-kumamoto-kumamotoshi" style={linkStyle}>新水前寺駅</Link>はJR豊肥本線と熊本市電の乗換拠点です。住宅地に位置し、通勤・通学利用が中心の駅で、市電との乗り換え需要が乗降者数を押し上げています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>熊本県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              熊本県は路面電車（熊本市電）が市民の重要な足として機能しており、熊本市への集中が顕著です。JRは都市間移動と郊外からの通勤を担い、市電は市内の移動を支えるという役割分担があります。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>熊本駅周辺</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              熊本駅周辺は九州新幹線開業以降、再開発が進んだエリアです。駅ビル「アミュプラザくまもと」や周辺の商業施設が充実し、交通利便性と商業機能が高まっています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>市電沿線エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              熊本市電沿線は市中心部の通町筋・辛島町エリアを中心に商業施設が集積しています。市電沿線は住宅地としても人気があり、生活利便性の高いエリアです。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。熊本県では市電沿線とJR沿線で異なる生活環境があります。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/kumamoto" style={linkStyle}>熊本県の駅ランキング（全件）</Link>では完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の熊本県駅乗降者数ランキングでは、熊本駅・新水前寺駅が上位を占めています。九州新幹線と路面電車の二つの交通軸が、熊本市の鉄道利用を支えています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>熊本県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/kumamoto" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              熊本県の全駅ランキング
            </Link>
