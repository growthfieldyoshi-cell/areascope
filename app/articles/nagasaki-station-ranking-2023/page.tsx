...
export default async function NagasakiStationRanking2023Page() {
  ...
  const rows = (await sql`
    ...
    WHERE s.station_group_slug IS NOT NULL
      AND s.prefecture_slug = 'nagasaki'
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '長崎県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          長崎県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、長崎県で最も利用者が多い駅は長崎駅・諫早駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          長崎県は西九州新幹線の開業で鉄道環境が大きく変化しました。国土交通省「国土数値情報」の{year}年データをもとに、長崎県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/nagasaki" style={linkStyle}>長崎県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>長崎県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の長崎県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>長崎駅が上位の理由</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/nagasaki-nagasaki-nagasakishi" style={linkStyle}>長崎駅</Link>は西九州新幹線の終点であり、県最大のターミナル駅です。観光都市・長崎の玄関口として、ビジネス・観光の両面で多くの利用者を集めています。駅ビルの再開発も進み、周辺の賑わいが増しています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>諫早駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/isahaya-nagasaki-soushi" style={linkStyle}>諫早駅</Link>はJR長崎本線と大村線の分岐点であり、県央の交通拠点です。西九州新幹線の停車駅でもあり、長崎市と佐世保市を結ぶ交通の要衝としての役割を担っています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>長崎県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              長崎県は西九州新幹線の開業で鉄道環境が変化しました。長崎市と佐世保市の二極構造が県の特徴で、路面電車（長崎電気軌道）も長崎市内の重要な交通手段として機能しています。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>長崎駅周辺</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              長崎駅周辺は西九州新幹線開業に伴う再開発で大きく変貌しています。駅ビルや商業施設が充実し、観光の起点としても利便性が高まっています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>諫早・大村エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              諫早市・大村市は県央の生活拠点として人口が比較的安定しているエリアです。長崎空港にも近く、交通利便性の高さが特徴です。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。長崎県では坂の多い地形も住環境に影響します。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/nagasaki" style={linkStyle}>長崎県の駅ランキング（全件）</Link>では完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の長崎県駅乗降者数ランキングでは、長崎駅・諫早駅が上位を占めています。西九州新幹線の開業により鉄道利用の環境が変化しつつあり、今後の動向が注目されます。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>長崎県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/nagasaki" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              長崎県の全駅ランキング
            </Link>
