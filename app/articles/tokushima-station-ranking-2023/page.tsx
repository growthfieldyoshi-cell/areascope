...
export const metadata: Metadata = {
  title: '徳島県の駅乗降者数ランキング｜主要駅TOP20',
  description: '徳島県の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/tokushima-station-ranking-2023',
  },
};
...
export default async function TokushimaStationRanking2023Page() {
  ...
  const rows = (await sql`
    ...
    WHERE s.station_group_slug IS NOT NULL
      AND s.prefecture_slug = 'tokushima'
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '徳島県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          徳島県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、徳島県で最も利用者が多い駅は徳島駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          徳島県は全国で唯一電化鉄道がない県として知られ、車社会が極めて顕著です。国土交通省「国土数値情報」の{year}年データをもとに、徳島県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/tokushima" style={linkStyle}>徳島県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>徳島県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の徳島県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>徳島駅が上位の理由</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/tokushima-tokushima-tokushimashi" style={linkStyle}>徳島駅</Link>は県庁所在地であり、JR高徳線と牟岐線の起点です。県内最大のターミナル駅として、通勤・通学・商業需要を一手に集めています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>勝瑞駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/shouzui-tokushima-aizumimachi" style={linkStyle}>勝瑞駅</Link>は藍住町に位置する住宅地の駅で、徳島市への通勤利用が中心です。近隣に商業施設も多く、生活利便性の高いエリアにあります。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>徳島県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              徳島県は全国で唯一電化鉄道がない県であり、車社会が極めて顕著です。鉄道の利用者数は全国的に見ても少ない水準ですが、徳島駅周辺では通勤・通学での鉄道利用が一定数あります。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>徳島駅周辺</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              徳島駅周辺は県庁所在地の中心部として行政機関・商業施設が集積しています。阿波踊りの本場としても知られ、観光シーズンには来街者が増加します。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>藍住・北島エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              徳島市近郊の藍住町・北島町は人口増加傾向にある住宅エリアです。大型商業施設が立地し、車でのアクセスを前提とした生活圏が形成されています。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。徳島県では車の利便性が生活の基盤であり、鉄道アクセスは補助的な位置づけです。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/tokushima" style={linkStyle}>徳島県の駅ランキング（全件）</Link>では完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の徳島県駅乗降者数ランキングでは、徳島駅が突出した利用者数を記録しています。全国唯一の非電化県として車社会が顕著ですが、徳島駅周辺では一定の鉄道需要があります。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>徳島県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/tokushima" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              徳島県の全駅ランキング
            </Link>
