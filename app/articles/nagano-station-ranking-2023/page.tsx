...
export const metadata: Metadata = {
  title: '長野県の駅乗降者数ランキング｜主要駅TOP20',
  description: '長野県の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/nagano-station-ranking-2023',
  },
};
...
export default async function NaganoStationRanking2023Page() {
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '長野県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          長野県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、長野県で最も利用者が多い駅は長野駅・松本駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          長野県は南北に長い県土に長野市と松本市の二極構造を持つ地域です。国土交通省「国土数値情報」の{year}年データをもとに、長野県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/nagano" style={linkStyle}>長野県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>長野県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の長野県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>長野駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/nagano-nagano-naganoshi" style={linkStyle}>長野駅</Link>は北陸新幹線の停車駅であり、善光寺観光の玄関口です。しなの鉄道・長野電鉄も乗り入れ、県北部の交通の要衝として機能しています。新幹線開業以降、東京方面からのアクセスが向上し、ビジネス・観光双方の需要が増加しています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>松本駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/matsumoto-nagano-matsumotoshi" style={linkStyle}>松本駅</Link>は篠ノ井線・大糸線の拠点であり、上高地・安曇野方面への観光拠点としても重要です。松本城を擁する城下町としての観光需要と、県中部の生活・商業拠点としての通勤需要が重なっています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>長野県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              長野県は南北に長い県土を持ち、長野市と松本市の二極構造が特徴です。北陸新幹線沿線の県北部と、中央本線沿線の県中部でそれぞれ異なる鉄道利用のパターンがあり、観光需要も駅の利用者数に大きく影響しています。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>長野市エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              県庁所在地の長野市は善光寺を中心とした歴史ある都市です。北陸新幹線で東京から約1時間半と、首都圏からのアクセスが良好で、移住需要も見られます。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>松本市エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              松本市は県中部の拠点都市で、松本城を中心とした観光と生活機能が共存するエリアです。特急あずさで新宿方面への直通アクセスがあり、首都圏との結びつきも強いです。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。長野県では新幹線駅周辺の利便性は高いものの、生活全般では車の利用も重要です。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/nagano" style={linkStyle}>長野県の駅ランキング（全件）</Link>では100位までの完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の長野県駅乗降者数ランキングでは、長野駅と松本駅が上位を占めています。北陸新幹線と中央本線という2つの幹線がそれぞれの拠点を支え、観光需要も加わって県の鉄道利用を牽引しています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>長野県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/nagano" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              長野県の全駅ランキング
            </Link>
