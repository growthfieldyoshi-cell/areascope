...
export const metadata: Metadata = {
  title: '駅ランキングから見る住みやすい街｜AreaScope',
  description: '乗降者数ランキングをターミナル型・住宅型・バランス型に分けて住みやすさを整理します。',
  alternates: {
    canonical: 'https://areascope.jp/articles/station-ranking-livability',
  },
};
