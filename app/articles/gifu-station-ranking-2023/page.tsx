...
export default async function GifuStationRanking2023Page() {
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '岐阜県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          岐阜県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、岐阜県で最も利用者が多い駅は岐阜駅・大垣駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          岐阜県には名古屋圏の通勤需要を支える主要駅が存在します。国土交通省「国土数値情報」の{year}年データをもとに、岐阜県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/gifu" style={linkStyle}>岐阜県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>岐阜県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の岐阜県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>岐阜駅が上位の理由</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/gifu-gifu-gifushi" style={linkStyle}>岐阜駅</Link>はJR東海道本線・高山本線の結節点であり、名古屋通勤圏の主要駅として多くの利用者を集めています。名古屋駅まで快速で約20分というアクセスの良さが、乗降者数の多さに直結しています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>大垣駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/oogaki-gifu-oogakishi" style={linkStyle}>大垣駅</Link>はJR東海道本線の拠点駅で、大垣夜行（ムーンライトながら）で全国的な知名度を持ちます。県西部の中核都市として、通勤・通学需要を支えています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>岐阜県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              岐阜県は名古屋圏のベッドタウンとしての性格が強く、全体的に車社会ですが、岐阜駅周辺は鉄道利用も活発です。名古屋方面への通勤需要が乗降者数に大きく影響しており、JR東海道本線沿線に利用者が集中する傾向があります。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>岐阜駅周辺</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              岐阜駅周辺は県庁所在地の中心部として商業施設が集積しています。名古屋への通勤利便性が高く、再開発も進んでおり、住宅需要も堅調です。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>大垣・各務原エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              大垣市は県西部の拠点都市として独自の商圏を持ちます。各務原市はJR高山本線・名鉄各務原線沿線で名古屋方面への通勤利便性が高いエリアです。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。岐阜県では鉄道アクセスに加えて車の利便性も重要な要素です。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/gifu" style={linkStyle}>岐阜県の駅ランキング（全件）</Link>では完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の岐阜県駅乗降者数ランキングでは、岐阜駅・大垣駅が上位を占めています。名古屋通勤圏としての需要がJR東海道本線沿線の乗降者数を押し上げています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>岐阜県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/gifu" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              岐阜県の全駅ランキング
            </Link>
