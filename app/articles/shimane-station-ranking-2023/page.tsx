...
export default async function ShimaneStationRanking2023Page() {
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '島根県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          島根県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、島根県で最も利用者が多い駅は松江駅・出雲市駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          島根県には県庁所在地の松江と出雲大社の玄関口である出雲市に主要駅が集中しています。国土交通省「国土数値情報」の{year}年データをもとに、島根県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/shimane" style={linkStyle}>島根県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>島根県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の島根県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>松江駅が上位の理由</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/matsue-shimane-matsueshi" style={linkStyle}>松江駅</Link>は県庁所在地であり、JR山陰本線の拠点駅です。行政機関や企業が集積する松江市の中核として、通勤・通学需要を支えています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>出雲市駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/izumoshi-shimane-izumoshi" style={linkStyle}>出雲市駅</Link>は出雲大社への玄関口として観光需要が大きい駅です。一畑電車の乗り換え拠点でもあり、地域住民の通勤・通学利用に加えて観光客の利用も多い駅です。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>島根県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              島根県は松江と出雲の二極構造が特徴で、全体的に乗降者数は少ない傾向にあります。JR山陰本線沿線に主要駅が集中しており、県全体では車社会が中心ですが、松江・出雲市の中心部では一定の鉄道利用があります。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>松江駅周辺</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              松江駅周辺は県庁所在地の中心部として行政機関・商業施設が集積しています。松江城や宍道湖など観光資源も豊富で、居住・観光の両面で需要があります。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>出雲市駅周辺</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              出雲市駅周辺は出雲大社への観光拠点としての性格が強いエリアです。一畑電車で出雲大社方面へのアクセスが可能で、観光シーズンには利用者が増加します。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。島根県では鉄道アクセスに加えて車の利便性も重要な要素です。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/shimane" style={linkStyle}>島根県の駅ランキング（全件）</Link>では完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の島根県駅乗降者数ランキングでは、松江駅・出雲市駅が上位を占めています。県庁所在地としての通勤需要と観光需要がそれぞれの乗降者数を支えています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>島根県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/shimane" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              島根県の全駅ランキング
            </Link>
