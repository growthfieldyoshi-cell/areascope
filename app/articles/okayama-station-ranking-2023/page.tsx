...
export const metadata: Metadata = {
  title: '岡山県の駅乗降者数ランキング｜主要駅TOP20',
  description: '岡山県の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/okayama-station-ranking-2023',
  },
};
...
export default async function OkayamaStationRanking2023Page() {
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '岡山県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          岡山県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、岡山県で最も利用者が多い駅は岡山駅です。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          岡山県は岡山駅を中心とした交通網が特徴的な地域です。国土交通省「国土数値情報」の{year}年データをもとに、岡山県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/okayama" style={linkStyle}>岡山県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>岡山県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の岡山県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>岡山駅が圧倒的1位の理由</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/okayama-okayama-okayamashi" style={linkStyle}>岡山駅</Link>は山陽新幹線・山陽本線・瀬戸大橋線・赤穂線・津山線・吉備線が集まる中国・四国地方の交通の要衝です。四国方面への玄関口としても機能しており、乗り換え需要が非常に大きいことが圧倒的な乗降者数につながっています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>中庄駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/nakashou-okayama-kurashikishi" style={linkStyle}>中庄駅</Link>は倉敷市内に位置し、岡山方面への通勤利用が中心の駅です。周辺は住宅地として発展しており、日常的な通勤・通学需要が安定しています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>岡山県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              岡山県は岡山駅への一極集中が顕著です。車社会の傾向が強い一方、岡山市内では鉄道利用も一定の需要があります。岡山駅と倉敷駅を結ぶ山陽本線沿線が最も利用者の多い区間となっています。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>岡山市中心部</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              岡山駅周辺は県内の商業・ビジネスの中心地です。新幹線停車駅としての拠点性が高く、再開発も進んでいます。路面電車も走っており、市中心部の交通利便性は高いです。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>倉敷エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              倉敷市は岡山市に次ぐ県内第2の都市で、美観地区を擁する観光都市でもあります。倉敷駅周辺は商業施設が集積し、生活利便性も高いエリアです。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。岡山県では岡山駅周辺の利便性は高いものの、家賃とのバランスを考えると周辺駅も選択肢に入ります。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/okayama" style={linkStyle}>岡山県の駅ランキング（全件）</Link>では100位までの完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の岡山県駅乗降者数ランキングでは、岡山駅が圧倒的な1位を記録しています。新幹線と在来線複数路線が交差する交通の要衝であり、四国方面への乗り換え需要も加わって県内で突出した利用者数となっています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>岡山県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/okayama" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              岡山県の全駅ランキング
            </Link>
