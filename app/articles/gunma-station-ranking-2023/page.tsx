...
export const metadata: Metadata = {
  title: '群馬県の駅乗降者数ランキング｜主要駅TOP20',
  description: '群馬県の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/gunma-station-ranking-2023',
  },
};
