...
export const metadata: Metadata = {
  title: '富山県の駅乗降者数ランキング｜主要駅TOP20',
  description: '富山県の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/toyama-station-ranking-2023',
  },
};
...
export default async function ToyamaStationRanking2023Page() {
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '富山県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          富山県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、富山県で最も利用者が多い駅は富山駅・高岡駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          富山県はLRT・路面電車の活用が特徴的な地域です。国土交通省「国土数値情報」の{year}年データをもとに、富山県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/toyama" style={linkStyle}>富山県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>富山県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の富山県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>富山駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/toyama-toyama-toyamashi" style={linkStyle}>富山駅</Link>は北陸新幹線・あいの風とやま鉄道・富山地方鉄道が集まる県内最大のターミナル駅です。LRT（富山ライトレール）の整備により駅前の交通利便性が大きく向上し、コンパクトシティのモデルケースとしても注目されています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>高岡駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/takaoka-toyama-takaokashi" style={linkStyle}>高岡駅</Link>はJR城端線・氷見線の起点であり、あいの風とやま鉄道も乗り入れる県西部の拠点駅です。万葉線（路面電車）も接続しており、高岡市の商業・交通の中心として機能しています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>富山県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              富山県はLRT・路面電車の活用が全国的にも特徴的です。富山駅を中心としたコンパクトシティ政策により、公共交通の利便性向上が進んでいます。北陸新幹線開業後はあいの風とやま鉄道が並行在来線を引き継ぎ、地域の足として機能しています。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>富山市エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              富山駅周辺はLRT整備による再開発が進み、コンパクトシティの先進事例として知られています。駅周辺に商業・行政機能が集約され、歩いて暮らせるまちづくりが推進されています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>高岡・射水エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              県西部の高岡市は歴史ある商業都市で、万葉線で射水市（新湊）方面へもアクセスできます。高岡駅周辺は商業施設が集積し、県西部の生活拠点として機能しています。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。富山県ではLRT沿線の利便性が向上していますが、全体的には車社会です。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/toyama" style={linkStyle}>富山県の駅ランキング（全件）</Link>では100位までの完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の富山県駅乗降者数ランキングでは、富山駅と高岡駅が上位を占めています。北陸新幹線とLRT整備の効果で富山駅の利便性が向上し、コンパクトシティ政策と連動した鉄道利用の変化が見られます。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>富山県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/toyama" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              富山県の全駅ランキング
            </Link>
