...
export const metadata: Metadata = {
  title: '石川県の駅乗降者数ランキング｜主要駅TOP20',
  description: '石川県の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/ishikawa-station-ranking-2023',
  },
};
...
export default async function IshikawaStationRanking2023Page() {
  ...
  const rows = (await sql`
    ...
    WHERE s.station_group_slug IS NOT NULL
      AND s.prefecture_slug = 'ishikawa'
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '石川県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          石川県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、石川県で最も利用者が多い駅は金沢駅です。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          石川県は金沢駅を中心とした一極集中型の鉄道利用が特徴です。国土交通省「国土数値情報」の{year}年データをもとに、石川県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/ishikawa" style={linkStyle}>石川県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>石川県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の石川県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>金沢駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/kanazawa-ishikawa-kanazawashi" style={linkStyle}>金沢駅</Link>は北陸新幹線の開業後に利用者が大幅に増加した駅です。IRいしかわ鉄道・北陸鉄道も乗り入れ、兼六園や金沢21世紀美術館への観光需要と、県都としてのビジネス・通勤需要が重なって高い乗降者数を記録しています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>津幡駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/tsubata-ishikawa-tsubatamachi" style={linkStyle}>津幡駅</Link>はIRいしかわ鉄道とJR七尾線の分岐点に位置する乗換駅です。能登方面へのアクセス拠点であり、乗り換え需要が利用者数を押し上げています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>石川県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              石川県は金沢一極集中の傾向が強く、北陸新幹線の開業効果により観光需要が大幅に増加しました。金沢駅を中心にIRいしかわ鉄道・北陸鉄道が放射状に路線を持ち、県内の鉄道ネットワークを形成しています。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>金沢市エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              金沢駅周辺は新幹線開業後に大きく変貌し、ホテルや商業施設の開発が進んでいます。兼六園周辺の観光エリアと、駅西側のビジネスエリアで性格が異なります。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>加賀・能登エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              加賀温泉方面や能登方面は観光需要が中心で、日常的な鉄道利用は限られています。七尾線沿線は能登半島へのアクセス路線として一定の利用があります。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。石川県では金沢駅周辺は利便性が高いものの、北陸鉄道沿線の郊外駅も住宅地としての需要があります。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/ishikawa" style={linkStyle}>石川県の駅ランキング（全件）</Link>では100位までの完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の石川県駅乗降者数ランキングでは、金沢駅が圧倒的な1位を記録しています。北陸新幹線の開業効果により観光需要が増加し、県都としての通勤需要と合わせて金沢一極集中の構造が鮮明です。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>石川県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/ishikawa" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              石川県の全駅ランキング
            </Link>
