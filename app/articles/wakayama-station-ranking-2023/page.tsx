...
export const metadata: Metadata = {
  title: '和歌山県の駅乗降者数ランキング｜主要駅TOP20',
  description: '和歌山県の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/wakayama-station-ranking-2023',
  },
};
...
export default async function WakayamaStationRanking2023Page() {
  ...
  const rows = (await sql`
    ...
    WHERE s.station_group_slug IS NOT NULL
      AND s.prefecture_slug = 'wakayama'
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '和歌山県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          和歌山県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、和歌山県で最も利用者が多い駅は和歌山駅・和歌山市駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          和歌山県は和歌山市周辺に鉄道利用が集中する地域です。国土交通省「国土数値情報」の{year}年データをもとに、和歌山県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/wakayama" style={linkStyle}>和歌山県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>和歌山県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の和歌山県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>和歌山駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/wakayama-wakayama-wakayamashi" style={linkStyle}>和歌山駅</Link>はJR阪和線・紀勢本線・和歌山線が集まる県内最大のターミナル駅です。大阪方面への通勤・通学需要と、紀南方面へのアクセス拠点としての機能を兼ね備えています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>和歌山市駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/wakayamashi-wakayama-wakayamashi" style={linkStyle}>和歌山市駅</Link>は南海本線の終点であり、大阪難波方面への直通アクセスを持つ駅です。和歌山市の中心部に位置し、商業施設の再開発も進んでいます。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>和歌山県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              和歌山県は車社会の傾向が強く、鉄道利用は和歌山市周辺に集中しています。県南部の紀南地域では鉄道利用が限られ、JR紀勢本線の利用者数も和歌山市近郊と比べると大きな差があります。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>和歌山市中心部</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              和歌山駅・和歌山市駅を中心としたエリアは県内の商業・行政の中心です。JRと南海の2つのターミナルが市内に併存し、それぞれ異なる方面へのアクセスを提供しています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>紀北エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              和歌山市北部から岩出市・紀の川市にかけてのエリアは大阪への通勤圏の境界にあたります。JR阪和線沿線では一定の通勤需要があります。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。和歌山県は車社会の側面が強いため、鉄道利用だけでなく道路アクセスも含めた総合的な判断が重要です。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/wakayama" style={linkStyle}>和歌山県の駅ランキング（全件）</Link>では100位までの完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の和歌山県駅乗降者数ランキングでは、和歌山駅と和歌山市駅が上位を占めています。JRと南海という2つの鉄道ネットワークが和歌山市に集中しており、県内の鉄道利用は和歌山市周辺に偏っています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>和歌山県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/wakayama" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              和歌山県の全駅ランキング
            </Link>
