...
export const metadata: Metadata = {
  title: '広島県の駅乗降者数ランキング｜主要駅TOP20',
  description: '広島県の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/hiroshima-station-ranking-2023',
  },
};
...
export default async function HiroshimaStationRanking2023Page() {
  ...
  const rows = (await sql`
    ...
    WHERE s.station_group_slug IS NOT NULL
      AND s.prefecture_slug = 'hiroshima'
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '広島県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          広島県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、広島県で利用者が多い駅は福山駅・本通駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          広島県には路面電車・アストラムラインなど独自の交通体系を持つ主要駅が並んでいます。国土交通省「国土数値情報」の{year}年データをもとに、広島県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/hiroshima" style={linkStyle}>広島県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>広島県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の広島県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>福山駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/fukuyama-hiroshima-fukuyamashi" style={linkStyle}>福山駅</Link>は山陽新幹線の停車駅であり、広島県東部の経済拠点です。JR山陽本線・福塩線も乗り入れており、県東部の通勤・通学需要の中核を担っています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>本通駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/hondoori-hiroshima-hiroshimashi" style={linkStyle}>本通駅</Link>はアストラムラインの駅で、広島市中心部の商業エリアに位置しています。本通商店街に直結しており、買い物・通勤の需要が集中する広島市の中心駅の一つです。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>広島の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              広島県は路面電車（広島電鉄）・アストラムラインなど独自の交通体系が特徴です。JRだけでなくこれらの交通機関が日常の足として機能しており、乗降者数の分布も他県とは異なるパターンを示しています。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>広島市中心部（広島駅・本通）</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              広島駅周辺は再開発が進み、交通利便性・商業施設ともに充実しています。本通エリアは商業の中心地として賑わいがありますが、住環境としては繁華街に近い点を考慮する必要があります。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>アストラムライン沿線</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              アストラムライン沿線は広島市北部の住宅地を結んでおり、通勤利便性と住環境のバランスが取れたエリアが多い傾向があります。中間駅周辺は生活拠点としての実用性が高いケースが多いです。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。広島では路面電車やアストラムラインの中間駅周辺がコストと利便性のバランスが取れやすい傾向があります。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/hiroshima" style={linkStyle}>広島県の駅ランキング（全件）</Link>では100位までの完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の広島県駅乗降者数ランキングでは、福山駅や本通駅など特徴的な駅が上位に並んでいます。路面電車・アストラムラインなど独自の交通体系が広島県の駅利用パターンを特徴づけています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>広島県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/hiroshima" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              広島県の全駅ランキング
            </Link>
