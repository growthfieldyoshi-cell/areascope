...
export const metadata: Metadata = {
  title: '栃木県の駅乗降者数ランキング｜主要駅TOP20',
  description: '栃木県の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/tochigi-station-ranking-2023',
  },
};
