...
export const metadata: Metadata = {
  title: '山口県の駅乗降者数ランキング｜主要駅TOP20',
  description: '山口県の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/yamaguchi-station-ranking-2023',
  },
};
...
export default async function YamaguchiStationRanking2023Page() {
  ...
  const rows = (await sql`
    ...
    WHERE s.station_group_slug IS NOT NULL
      AND s.prefecture_slug = 'yamaguchi'
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '山口県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          山口県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、山口県で最も利用者が多い駅は下関駅・新山口駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          山口県は都市が分散しており、下関と山口市を中心に鉄道利用が分布しています。国土交通省「国土数値情報」の{year}年データをもとに、山口県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/yamaguchi" style={linkStyle}>山口県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>山口県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の山口県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>下関駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/shimonoseki-yamaguchi-shimonosekishi" style={linkStyle}>下関駅</Link>は九州への玄関口であり、関門トンネルを通じて北九州市と直結しています。山陽本線の終点であると同時に、山陰本線の起点でもあり、交通の要衝として高い乗降者数を記録しています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>新山口駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/shinyamaguchi-yamaguchi-yamaguchishi" style={linkStyle}>新山口駅</Link>は山陽新幹線の停車駅であり、県庁所在地・山口市へのアクセス拠点です。山口線への乗り換え駅としても機能しており、ビジネスや行政関連の利用が多い駅です。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>山口県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              山口県は都市が分散しており、下関市と山口市で二極構造を形成しています。下関は北九州圏との結びつきが強く、新山口は県の行政中心地へのアクセス拠点です。県全体としては車社会の傾向が強く、鉄道利用は主要都市に限られています。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>下関エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              下関市は山口県最大の人口を擁する都市で、北九州市との経済的結びつきが強いエリアです。関門海峡を挟んで九州圏の通勤・通学需要があり、鉄道利用も比較的活発です。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>山口市・周南エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              新山口駅を中心とした山口市エリアは県の行政機能が集中しています。周南市の徳山駅も新幹線停車駅として一定の利用があり、工業都市としての通勤需要も見られます。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。山口県は車社会の側面が強いため、鉄道利用だけでなく道路アクセスも含めた総合的な判断が重要です。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/yamaguchi" style={linkStyle}>山口県の駅ランキング（全件）</Link>では100位までの完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の山口県駅乗降者数ランキングでは、下関駅と新山口駅が上位を占めています。九州への玄関口としての下関と、新幹線アクセスの新山口という二つの拠点が県の鉄道利用を牽引しています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>山口県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/yamaguchi" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              山口県の全駅ランキング
            </Link>
