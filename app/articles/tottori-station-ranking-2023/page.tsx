...
export const metadata: Metadata = {
  title: '鳥取県の駅乗降者数ランキング｜主要駅TOP20',
  description: '鳥取県の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/tottori-station-ranking-2023',
  },
};
...
export default async function TottoriStationRanking2023Page() {
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '鳥取県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          鳥取県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、鳥取県で最も利用者が多い駅は鳥取駅・米子駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          鳥取県には東部の鳥取市と西部の米子市に主要駅が集中しています。国土交通省「国土数値情報」の{year}年データをもとに、鳥取県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/tottori" style={linkStyle}>鳥取県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>鳥取県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の鳥取県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>鳥取駅が上位の理由</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/tottori-tottori-tottorishi" style={linkStyle}>鳥取駅</Link>は県庁所在地であり、JR山陰本線と因美線の結節点です。県東部の行政・商業の中核として通勤・通学需要を集めています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>米子駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/yonago-tottori-yonagoshi" style={linkStyle}>米子駅</Link>は県西部の拠点駅で、境線の起点でもあります。山陰地方の交通の要衝として、島根県方面への乗り換え需要も含めた利用があります。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>鳥取県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              鳥取県は東部の鳥取市と西部の米子市の二極構造が特徴です。県の東西に主要都市が分かれており、それぞれの都市圏で独自の通勤・通学圏を形成しています。全体的に車社会ですが、両駅周辺では一定の鉄道利用があります。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>鳥取駅周辺</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              鳥取駅周辺は県庁所在地の中心部として行政機関・商業施設が集積しています。鳥取砂丘など観光資源へのアクセス拠点でもあります。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>米子駅周辺</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              米子駅周辺は県西部の商業・交通の中心地です。皆生温泉や大山へのアクセス拠点としての性格も持ち、観光需要も一定あります。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。鳥取県では鉄道アクセスに加えて車の利便性も重要な要素です。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/tottori" style={linkStyle}>鳥取県の駅ランキング（全件）</Link>では完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の鳥取県駅乗降者数ランキングでは、鳥取駅・米子駅が上位を占めています。東部と西部の二極構造がそのまま乗降者数の分布に反映されています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>鳥取県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/tottori" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              鳥取県の全駅ランキング
            </Link>
