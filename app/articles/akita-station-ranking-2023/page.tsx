...
export default async function AkitaStationRanking2023Page() {
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '秋田県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          秋田県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、秋田県で最も利用者が多い駅は大曲駅・土崎駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          秋田県は人口減少が顕著な地域ですが、秋田市を中心に一定の鉄道利用があります。国土交通省「国土数値情報」の{year}年データをもとに、秋田県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/akita" style={linkStyle}>秋田県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>秋田県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の秋田県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>大曲駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/oomagari-akita-daisenshi" style={linkStyle}>大曲駅</Link>は秋田新幹線の停車駅であり、JR奥羽本線と田沢湖線の分岐点です。全国花火競技大会（大曲の花火）で知られ、花火大会期間中は利用者が大幅に増加します。県南部の交通拠点として日常的な通勤需要もあります。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>土崎駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/tsuchizaki-akita-akitashi" style={linkStyle}>土崎駅</Link>は秋田市北部に位置する住宅地の駅です。秋田港にも近く、周辺は住宅地として発展しており、秋田駅方面への通勤・通学需要が安定しています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>秋田県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              秋田県は全国でも人口減少が顕著な地域であり、鉄道利用者数も減少傾向にあります。秋田市への集中度が高く、秋田新幹線沿線の駅が比較的上位に位置しています。県全体としては車社会が進んでいます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>秋田市エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              秋田市は県の行政・商業・教育の中心地です。秋田駅を中心に商業施設が集積しており、県内で最も鉄道利用が活発なエリアです。土崎・追分など市内の各駅も一定の利用があります。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>県南エリア（大曲・横手）</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              県南部は大曲駅・横手駅を中心に、新幹線停車駅周辺で一定の鉄道利用があります。農業が盛んな地域で、季節による利用者数の変動も見られます。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。秋田県は車社会の側面が非常に強いため、鉄道利用だけでなく道路アクセスも含めた総合的な判断が重要です。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/akita" style={linkStyle}>秋田県の駅ランキング（全件）</Link>では100位までの完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の秋田県駅乗降者数ランキングでは、秋田市周辺の駅が上位を占めています。人口減少が進む中でも秋田市への集中度は高く、秋田新幹線沿線の駅が県の鉄道利用を牽引しています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>秋田県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/akita" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              秋田県の全駅ランキング
            </Link>
