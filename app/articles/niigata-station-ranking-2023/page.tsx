...
export default async function NiigataStationRanking2023Page() {
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '新潟県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          新潟県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、新潟県で最も利用者が多い駅は新潟駅です。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          新潟県では上越新幹線の終点・新潟駅を中心に主要駅が並んでいます。国土交通省「国土数値情報」の{year}年データをもとに、新潟県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/niigata" style={linkStyle}>新潟県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>新潟県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の新潟県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>新潟駅が1位の理由</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/niigata-niigata-niigatashi" style={linkStyle}>新潟駅</Link>は上越新幹線の終点であり、JR在来線（信越本線・白新線・越後線）が集まる新潟県の中核ターミナルです。県都の玄関口として通勤・通学需要に加え、ビジネス・観光需要も集中しており、県内で突出した乗降者数を記録しています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>長岡駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/nagaoka-niigata-nagaokashi" style={linkStyle}>長岡駅</Link>は上越新幹線の停車駅であり、新潟県内第2の都市・長岡市の拠点です。新幹線通勤の需要もあり、県内では新潟駅に次ぐ存在感を持っています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>新潟の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              新潟県は車社会のため、全体的に駅の乗降者数は少なめの傾向があります。その中で新潟駅の存在感が突出しており、2位以下との差が大きいのが特徴です。鉄道利用は新潟駅・長岡駅を中心とした限定的なエリアに集中しています。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>新潟駅周辺</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              新潟駅周辺は再開発が進み、商業施設・オフィスが集積しています。万代エリアと合わせて新潟市の中心市街地を形成しており、交通利便性は県内最高水準です。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>新幹線停車駅の生活利便性</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              新潟駅・長岡駅・燕三条駅など新幹線停車駅の周辺は、東京方面へのアクセスが良く、新幹線通勤も可能なエリアです。駅周辺の生活利便性と新幹線利用の利便性を合わせて評価することが重要です。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。新潟県は車社会のため、駅の乗降者数だけでは生活利便性を判断しにくい面があります。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/niigata" style={linkStyle}>新潟県の駅ランキング（全件）</Link>では100位までの完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の新潟県駅乗降者数ランキングでは、新潟駅が突出した利用者数を記録しています。上越新幹線の終点であることに加え、県都の中核ターミナルとしての機能が乗降者数の多さに直結しています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>新潟県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/niigata" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              新潟県の全駅ランキング
            </Link>
