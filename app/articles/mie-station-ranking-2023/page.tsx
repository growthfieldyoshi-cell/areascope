...
export default async function MieStationRanking2023Page() {
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '三重県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          三重県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、三重県で最も利用者が多い駅は近鉄四日市駅・津駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          三重県には近鉄を中心とした主要駅が集中しています。国土交通省「国土数値情報」の{year}年データをもとに、三重県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/mie" style={linkStyle}>三重県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>三重県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の三重県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>近鉄四日市が上位の理由</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/kintetsuyokkaichi-mie-yokkaichishi" style={linkStyle}>近鉄四日市駅</Link>は近鉄名古屋線・湯の山線の結節点であり、北勢地域の商業中心地です。四日市市は三重県最大の人口を擁し、名古屋方面への通勤・通学需要と地域内の商業需要が重なることで高い乗降者数を記録しています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>津駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/tsu-mie-tsushi" style={linkStyle}>津駅</Link>は県庁所在地に位置し、JR紀勢本線と近鉄名古屋線が接続する交通の要衝です。県の行政機能が集中しているため、通勤需要が安定しており、名古屋方面と伊勢方面の双方へのアクセス拠点としても機能しています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>三重県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              三重県では近鉄が主要交通機関として大きな役割を果たしています。北勢地域（四日市・桑名）と南勢地域（伊勢・志摩）では鉄道利用に大きな差があり、北勢地域は名古屋圏の通勤需要で利用者が多い一方、南勢地域は観光需要が中心です。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>北勢エリア（四日市・桑名）</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              三重県北部の北勢エリアは名古屋圏の通勤圏に入り、鉄道利用が活発です。近鉄四日市駅周辺は商業施設が集積し、県内最大の商業エリアとなっています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>中南勢エリア（津・松阪）</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              県庁所在地の津市を中心としたエリアは行政機能が集中し、安定した通勤需要があります。松阪は近鉄とJRの接続点として一定の利用があります。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。三重県は車社会の側面が強いため、鉄道利用だけでなく道路アクセスも含めた総合的な判断が重要です。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/mie" style={linkStyle}>三重県の駅ランキング（全件）</Link>では100位までの完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の三重県駅乗降者数ランキングでは、近鉄四日市駅と津駅が上位を占めています。北勢地域の名古屋圏通勤需要と、県庁所在地としての行政需要がそれぞれの駅の利用者数を支えています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>三重県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/mie" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              三重県の全駅ランキング
            </Link>
