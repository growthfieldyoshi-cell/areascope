...
export default async function SagaStationRanking2023Page() {
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '佐賀県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          佐賀県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、佐賀県で最も利用者が多い駅は佐賀駅・鳥栖駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          佐賀県は福岡都市圏の影響が大きく、鳥栖市は交通の要衝として知られています。国土交通省「国土数値情報」の{year}年データをもとに、佐賀県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/saga" style={linkStyle}>佐賀県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>佐賀県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の佐賀県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>佐賀駅が上位の理由</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/saga-saga-sagashi" style={linkStyle}>佐賀駅</Link>はJR長崎本線の主要駅であり、県庁所在地のターミナルです。行政機関や商業施設が集積し、県内最大の通勤・通学需要を支えています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>鳥栖駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/tosu-saga-tosushi" style={linkStyle}>鳥栖駅</Link>はJR鹿児島本線と長崎本線の分岐点であり、九州の交通の要衝です。福岡都市圏への通勤アクセスが良く、物流拠点としても発展しています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>佐賀県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              佐賀県は福岡都市圏の影響が大きく、鳥栖市を中心に福岡方面への通勤需要があります。佐賀市は県庁所在地として独自の需要を持ち、鳥栖市は交通結節点・物流拠点としての性格が強い傾向があります。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>佐賀駅周辺</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              佐賀駅周辺は県庁所在地の中心部として行政機関・商業施設が集積しています。比較的コンパクトな市街地で、生活利便性の高いエリアです。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>鳥栖駅周辺</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              鳥栖駅周辺は交通の要衝として物流施設が集積しています。鳥栖プレミアム・アウトレットなど商業施設も充実し、福岡通勤圏として住宅需要も堅調です。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。佐賀県では福岡へのアクセス利便性が住宅選びの重要な要素です。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/saga" style={linkStyle}>佐賀県の駅ランキング（全件）</Link>では完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の佐賀県駅乗降者数ランキングでは、佐賀駅・鳥栖駅が上位を占めています。県庁所在地の佐賀市と交通の要衝である鳥栖市が、県内の鉄道利用を支えています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>佐賀県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/saga" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              佐賀県の全駅ランキング
            </Link>
