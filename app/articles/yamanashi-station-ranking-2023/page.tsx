...
export const metadata: Metadata = {
  title: '山梨県の駅乗降者数ランキング｜主要駅TOP20',
  description: '山梨県の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/yamanashi-station-ranking-2023',
  },
};
...
export default async function YamanashiStationRanking2023Page() {
  ...
  const rows = (await sql`
    ...
    WHERE s.station_group_slug IS NOT NULL
      AND s.prefecture_slug = 'yamanashi'
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '山梨県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          山梨県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、山梨県で最も利用者が多い駅は甲府駅・大月駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          山梨県は甲府盆地を中心に鉄道利用が集中する地域です。国土交通省「国土数値情報」の{year}年データをもとに、山梨県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/yamanashi" style={linkStyle}>山梨県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>山梨県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の山梨県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>甲府駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/koufu-yamanashi-koufushi" style={linkStyle}>甲府駅</Link>は県庁所在地に位置し、JR中央本線と身延線の結節点です。特急あずさ・かいじの停車駅として東京方面へのアクセス拠点であり、県内の行政・商業機能が集中していることから通勤需要も安定しています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>大月駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/ootsuki-yamanashi-ootsukishi" style={linkStyle}>大月駅</Link>はJR中央本線と富士急行線の乗換駅であり、東京通勤圏の境界に位置します。富士山方面への観光アクセスの分岐点でもあり、通勤と観光の双方の乗り換え需要が乗降者数を押し上げています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>山梨県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              山梨県は車社会が非常に顕著な地域であり、鉄道利用は甲府盆地に集中しています。JR中央本線沿線が主要な鉄道軸となっており、東京方面への特急利用が県内の鉄道需要の大きな部分を占めています。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>甲府エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              甲府市は県の行政・商業の中心地で、甲府駅周辺にはオフィスや商業施設が集積しています。特急で新宿まで約1時間半と、首都圏との結びつきも強いエリアです。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>東部エリア（大月・上野原）</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              山梨県東部は東京通勤圏の境界にあたるエリアです。大月駅周辺は富士急行線への乗り換え拠点としての性格が強く、観光シーズンには利用者が増加します。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。山梨県は車社会が顕著なため、鉄道利用だけでなく道路アクセスも含めた総合的な判断が重要です。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/yamanashi" style={linkStyle}>山梨県の駅ランキング（全件）</Link>では100位までの完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の山梨県駅乗降者数ランキングでは、甲府駅と大月駅が上位を占めています。JR中央本線を軸とした東京方面へのアクセス需要が県の鉄道利用を支えており、甲府盆地に利用が集中しています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>山梨県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/yamanashi" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              山梨県の全駅ランキング
            </Link>
