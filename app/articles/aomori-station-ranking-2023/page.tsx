...
export const metadata: Metadata = {
  title: '青森県の駅乗降者数ランキング｜主要駅TOP20',
  description: '青森県の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/aomori-station-ranking-2023',
  },
};
