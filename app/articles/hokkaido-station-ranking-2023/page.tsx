...
export const metadata: Metadata = {
  title: '北海道の駅乗降者数ランキング｜主要駅TOP20',
  description: '北海道の駅乗降者数ランキングTOP20を掲載しています。',
  alternates: {
    canonical: 'https://areascope.jp/articles/hokkaido-station-ranking-2023',
  },
};
...
export default async function HokkaidoStationRanking2023Page() {
  ...
  const rows = (await sql`
    ...
    WHERE s.station_group_slug IS NOT NULL
      AND s.prefecture_slug = 'hokkaido'
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '北海道の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          北海道の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、北海道で最も利用者が多い駅は札幌駅です。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          北海道では札幌市内に主要駅が集中しています。国土交通省「国土数値情報」の{year}年データをもとに、北海道の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/hokkaido" style={linkStyle}>北海道の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>北海道の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の北海道における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>札幌駅が1位の理由</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/sapporo-hokkaido-sapporoshi" style={linkStyle}>札幌駅</Link>はJR北海道の在来線と地下鉄南北線が接続する北海道最大の結節点です。北海道の経済・行政の中核であり、通勤・通学需要に加えて観光客の利用も多く、圧倒的な乗降者数を記録しています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>大通駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/oodoori-hokkaido-sapporoshi" style={linkStyle}>大通駅</Link>は地下鉄南北線・東西線・東豊線の3路線が交差する札幌市中心部の駅です。大通公園に面した商業中心地であり、地下鉄の乗り換え需要が大きく、札幌駅に次ぐ利用者数を誇っています。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>北海道の駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              北海道の駅別乗降者数は札幌一極集中が顕著です。上位駅のほとんどが札幌市内に集中しており、他都市との差が非常に大きいのが特徴です。旭川・函館などの地方都市の駅は、札幌市内の駅と比べて大幅に乗降者数が少ない傾向があります。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>ターミナル駅周辺（札幌・大通）</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              札幌駅・大通駅周辺は交通利便性が極めて高く、商業施設も充実しています。ただし家賃水準も高く、冬季の積雪による通勤負担も考慮が必要です。
            </p>
          </div>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              地下鉄南北線・東西線・東豊線の沿線は、冬季でも安定した交通手段を確保できるため住宅地として人気が高い傾向があります。特に地下鉄駅徒歩圏は積雪の影響を受けにくく、実用的な居住エリアです。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。札幌では地下鉄沿線の中間駅周辺がコストと利便性のバランスが取れやすい傾向があります。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/hokkaido" style={linkStyle}>北海道の駅ランキング（全件）</Link>では100位までの完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の北海道駅乗降者数ランキングでは、札幌駅・大通駅が突出した利用者数を記録しています。北海道は札幌一極集中が顕著であり、上位駅のほとんどが札幌市内に集中しています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>北海道の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/hokkaido" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              北海道の全駅ランキング
            </Link>
