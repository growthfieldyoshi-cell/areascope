...
export default async function KagawaStationRanking2023Page() {
    ...
    <main style={{ background: '#0a0e1a', minHeight: '100vh', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px' }}>
        <Breadcrumb items={[
          ...
          { label: '香川県の駅乗降者数ランキング' },
        ]} />
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px', lineHeight: 1.4 }}>
          香川県の駅<span style={{ color: '#00d4aa' }}>乗降者数</span>ランキング（{year}年）
        </h1>

        <p style={{ color: '#e8edf5', fontSize: '16px', lineHeight: 1.8, marginBottom: '12px', fontWeight: 600 }}>
          {year}年、香川県で最も利用者が多い駅は高松駅・瓦町駅エリアです。
        </p>
        <p style={{ ...pStyle, marginBottom: '32px' }}>
          香川県はコンパクトな県域に主要駅が集中しています。国土交通省「国土数値情報」の{year}年データをもとに、香川県の駅別乗降者数ランキングTOP20と、上位駅の特徴・エリア分析への活用方法を解説します。最新の完全版ランキングは<Link href="/station-ranking/kagawa" style={linkStyle}>香川県の駅乗降者数ランキング（全件）</Link>から確認できます。
        </p>

        {/* TOP20テーブル */}
        <div style={sectionStyle}>
          <h2 style={h2Style}>香川県の駅乗降者数ランキングTOP20（{year}年）</h2>
          <p style={{ ...pStyle, marginBottom: '16px' }}>
            以下は{year}年の香川県における駅別乗降者数ランキングです。同じ駅名に複数路線がある場合は合算した数値です。
          </p>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>高松駅が上位の理由</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/takamatsu-kagawa-takamatsushi" style={linkStyle}>高松駅</Link>はJR予讃線・高徳線の拠点であり、四国の玄関口としての役割を担っています。瀬戸大橋を経由した本州方面との連絡拠点として、ビジネス・観光の両面で利用者を集めています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>瓦町駅の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              <Link href="/station/kawarachou-kagawa-takamatsushi" style={linkStyle}>瓦町駅</Link>はことでん（高松琴平電気鉄道）3路線の結節点で、高松市中心部の商業地に位置しています。地元住民の日常的な移動手段として、通勤・通学・買い物利用が活発です。
            </p>
          </div>

          <div>
            <h3 style={h3Style}>香川県の鉄道利用の特徴</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              香川県はコンパクトな県域で、高松市に鉄道利用が集中しています。JRとことでんの二系統があり、それぞれ異なる需要を支えています。全国で最も面積が小さい県ながら、高松市を中心とした鉄道ネットワークが形成されています。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>高松駅周辺</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              高松駅周辺はサンポート高松を中心とした再開発エリアで、商業施設・オフィスが集積しています。フェリー乗り場も近く、交通結節点としての機能が充実しています。
            </p>
          </div>

          <div style={{ marginBottom: '16px' }}>
            <h3 style={h3Style}>瓦町・片原町エリア</h3>
            <p style={{ ...pStyle, marginBottom: 0 }}>
              瓦町駅周辺は高松市の商業中心地で、商店街やデパートが立地しています。ことでん沿線は住宅地としても人気があり、生活利便性の高いエリアです。
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ ...pStyle, marginBottom: 0 }}>
              乗降者数が多い＝住みやすいとは限りません。香川県では鉄道アクセスに加えて車の利便性も重要な要素です。人口推移データと合わせて確認すると、居住需要の実態がより正確に把握できます。
            </p>
          </div>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={{ ...pStyle, marginBottom: 0 }}>
            AreaScopeでは各駅の時系列推移を確認できるため、コロナ前後の回復度合いや長期トレンドを把握するのにも活用できます。<Link href="/station-ranking/kagawa" style={linkStyle}>香川県の駅ランキング（全件）</Link>では完全版を掲載しています。
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={pStyle}>
            {year}年の香川県駅乗降者数ランキングでは、高松駅・瓦町駅が上位を占めています。コンパクトな県域ながら、JRとことでんの二系統が高松市の交通を支えています。
          </p>
          <p style={{ ...pStyle, marginBottom: 0 }}>
        ...
        <div style={{ ...sectionStyle, textAlign: 'center' as const }}>
          <h2 style={{ ...h2Style, marginBottom: '12px' }}>香川県の駅データを詳しく見る</h2>
          <p style={{ color: '#6b7a99', fontSize: '13px', marginBottom: '16px' }}>
            気になる駅があれば、詳細データを確認してみてください。
          </p>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link href="/station-ranking/kagawa" style={{ display: 'inline-block', color: '#00d4aa', border: '1px solid #00d4aa', borderRadius: '6px', padding: '10px 20px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
              香川県の全駅ランキング
            </Link>
